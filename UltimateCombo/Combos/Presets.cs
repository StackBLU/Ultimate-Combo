...
public enum Presets
{
    ...
    [CustomComboInfo("Auto Chocobo Stance", "", Common.JobID)]
    All_Choco = 100000,
    ...
    [ReplaceSkill(Common.TrueNorth, Common.SecondWind, Common.Bloodbath, Common.LucidDreaming, Common.ArmsLength)]
    [CustomComboInfo("Role Actions", "", Common.JobID)]
    All_RoleActions = 100010,

    [ParentCombo(All_RoleActions)]
    [CustomComboInfo("True North", "", Common.JobID)]
    All_TrueNorth = 100011,

    [ParentCombo(All_RoleActions)]
    [CustomComboInfo("Second Wind", "", Common.JobID)]
    All_SecondWind = 100012,

    [ParentCombo(All_RoleActions)]
    [CustomComboInfo("Bloodbath", "", Common.JobID)]
    All_Bloodbath = 100013,

    [ParentCombo(All_RoleActions)]
    [CustomComboInfo("Lucid Dreaming - WHM/SCH/AST/SGE", "", Common.JobID)]
    All_Healer_Lucid = 100014,

    [ParentCombo(All_RoleActions)]
    [CustomComboInfo("Lucid Dreaming - SMN/RDM/PCT", "", Common.JobID)]
    All_Mage_Lucid = 100015,

    [ParentCombo(All_RoleActions)]
    [CustomComboInfo("Lucid Dreaming - BLU", "", Common.JobID)]
    ...
    [ReplaceSkill(Common.Reprisal, Common.Feint, Common.Addle)]
    [CustomComboInfo("Mitigation Overwrite Protection", "", Common.JobID)]
    All_MitigationProtections = 100030,

    [ParentCombo(All_MitigationProtections)]
    [CustomComboInfo("Reprisal", "", Common.JobID)]
    All_Tank_Reprisal = 100031,

    [ParentCombo(All_MitigationProtections)]
    [CustomComboInfo("Feint", "", Common.JobID)]
    All_Melee_Feint = 100032,

    [ParentCombo(All_MitigationProtections)]
    [CustomComboInfo("Addle", "", Common.JobID)]
    All_Caster_Addle = 100033,

    [ReplaceSkill(Common.TrueNorth)]
    [CustomComboInfo("True North Protection", "", Common.JobID)]
    All_Melee_TrueNorth = 100034,

    [ReplaceSkill(MCH.Tactician, BRD.Troubadour, DNC.ShieldSamba)]
    [CustomComboInfo("Ranged Mitigation Protection", "", Common.JobID)]
    All_Ranged_Mitigation = 100035,

    [ReplaceSkill(WHM.Raise, SCH.Resurrection, AST.Ascend, SGE.Egeiro, RDM.Verraise, BLU.AngelWhisper)]
    [CustomComboInfo("Swift Raise (Includes Thin Air for WHM and Dualcast for RDM)", "", Common.JobID)]
    All_Raise = 100036,
    ...
    [CustomComboInfo("Wisdoms & Spirit of the Remembered", "", Common.JobID)]
    Eureka_Wisdoms = 100500,

    [Eureka]
    [ReplaceSkill(Eureka.Bloodbath, Eureka.MagicBurst, Eureka.DoubleEdge, Eureka.EagleEyeShot)]
    [CustomComboInfo("Offensive Actions", "", Common.JobID)]
    ...
    [Eureka]
    [ParentCombo(Eureka_Offensive)]
    [CustomComboInfo("Magic Burst", "", Common.JobID)]
    Eureka_MagicBurst = 100503,

    [Eureka]
    [ParentCombo(Eureka_Offensive)]
    [CustomComboInfo("Double Edge", "", Common.JobID)]
    Eureka_DoubleEdge = 100504,

    [Eureka]
    [ParentCombo(Eureka_Offensive)]
    [CustomComboInfo("Eagle Eye Shot", "", Common.JobID)]
    Eureka_EagleEyeShot = 100505,

    [Eureka]
    [ReplaceSkill(Eureka.Cure, Eureka.Cure2)]
    [CustomComboInfo("Curative Actions", "", Common.JobID)]
    Eureka_Curative = 100510,

    [Eureka]
    [ParentCombo(Eureka_Curative)]
    [CustomComboInfo("Cure", "", Common.JobID)]
    Eureka_Cure = 100511,

    [Eureka]
    [ParentCombo(Eureka_Curative)]
    [CustomComboInfo("Cure II", "", Common.JobID)]
    Eureka_Cure2 = 100512,

    [Eureka]
    [ReplaceSkill(Eureka.Swift, Eureka.Featherfoot, Eureka.Feint, Eureka.Backstep)]
    [CustomComboInfo("Tactical Actions", "", Common.JobID)]
    Eureka_Tactical = 100520,

    [Eureka]
    [ParentCombo(Eureka_Tactical)]
    [CustomComboInfo("Swift", "", Common.JobID)]
    Eureka_Swift = 100521,

    [Eureka]
    [ParentCombo(Eureka_Tactical)]
    [CustomComboInfo("Featherfoot", "", Common.JobID)]
    ...
    [Eureka]
    [ParentCombo(Eureka_Tactical)]
    [CustomComboInfo("Backstep", "", Common.JobID)]
    Eureka_Backstep = 100524,

    [Eureka]
    [ReplaceSkill(Eureka.Paralyze, Eureka.SpiritDart, Eureka.Tranquilizer)]
    [CustomComboInfo("Inimical Actions", "", Common.JobID)]
    Eureka_Inimical = 100530,

    [Eureka]
    [ParentCombo(Eureka_Inimical)]
    [CustomComboInfo("Paralyze", "", Common.JobID)]
    Eureka_Paralyze = 100531,

    [Eureka]
    [ParentCombo(Eureka_Inimical)]
    [CustomComboInfo("Spirit Dart", "", Common.JobID)]
    Eureka_SpiritDart = 100532,

    [Eureka]
    [ParentCombo(Eureka_Inimical)]
    [CustomComboInfo("Tranquilizer", "", Common.JobID)]
    Eureka_Tranquilizer = 100533,

    [Eureka]
    [ReplaceSkill(Eureka.Protect, Eureka.Shell, Eureka.Stoneskin)]
    [CustomComboInfo("Mitigative Actions", "", Common.JobID)]
    Eureka_Mitigative = 100540,

    [Eureka]
    [ParentCombo(Eureka_Mitigative)]
    [CustomComboInfo("Protect", "", Common.JobID)]
    Eureka_Protect = 100541,

    [Eureka]
    [ParentCombo(Eureka_Mitigative)]
    [CustomComboInfo("Shell", "", Common.JobID)]
    Eureka_Shell = 100542,

    [Eureka]
    [ParentCombo(Eureka_Mitigative)]
    [CustomComboInfo("Stoneskin", "", Common.JobID)]
    ...
    [CustomComboInfo("Lost Slash", "", Common.JobID)]
    Bozja_Slash = 100046,

    [Bozja]
    [ReplaceSkill(Bozja.Cure4)]
    [CustomComboInfo("Cure IV", "", Common.JobID)]
    Bozja_CureIV = 100047,
    ...
    [CustomComboInfo("Variant Cure", "", Common.JobID)]
    Variant_Cure = 100050,
    ...
    [CustomComboInfo("Variant Spirit Dart", "", Common.JobID)]
    ...
    [ReplaceSkill(BLM.Triplecast, Common.Swiftcast)]
    ...
    [CustomComboInfo("Recuperate", "", Common.JobID)]
    PvP_Recuperate = 1100000,

    [PvP]
    [ReplaceSkill(AllPvP.Guard)]
    [CustomComboInfo("Guard", "", Common.JobID)]
    PvP_Guard = 1100001,

    [PvP]
    [ReplaceSkill(AllPvP.Purify)]
    [CustomComboInfo("Purify", "", Common.JobID)]
    PvP_Purify = 1100002,

    [PvP]
    [ReplaceSkill(SAMPvP.Chiten)]
    [CustomComboInfo("Ignore SAM when Chiten is active", "", Common.JobID)]
    PvP_IgnoreSAMKuzuchi = 1100003,

    [PvP]
    [CustomComboInfo("Tank PvP Role Actions", "", Common.JobID)]
    TankPvP_RoleActions = 1100010,

    [PvP]
    [ReplaceSkill(AllPvP.Rampage)]
    [ParentCombo(TankPvP_RoleActions)]
    [CustomComboInfo("Rampage", "", Common.JobID)]
    TankPvP_Rampage = 1100011,

    [PvP]
    [ReplaceSkill(AllPvP.Rampart)]
    [ParentCombo(TankPvP_RoleActions)]
    [CustomComboInfo("Rampart", "", Common.JobID)]
    TankPvP_Rampart = 1100012,

    [PvP]
    [ReplaceSkill(AllPvP.FullSwing)]
    [ParentCombo(TankPvP_RoleActions)]
    [CustomComboInfo("Full Swing", "", Common.JobID)]
    TankPvP_FullSwing = 1100013,

    [PvP]
    [CustomComboInfo("Healer PvP Role Actions", "", Common.JobID)]
    HealerPvP_RoleActions = 1100020,

    [PvP]
    [ReplaceSkill(AllPvP.Stoneskin2)]
    [ParentCombo(HealerPvP_RoleActions)]
    [CustomComboInfo("Stoneskin II", "", Common.JobID)]
    HealerPvP_Stoneskin2 = 1100021,

    [PvP]
    [ReplaceSkill(AllPvP.Diabrosis)]
    [ParentCombo(HealerPvP_RoleActions)]
    [CustomComboInfo("Diabrosis", "", Common.JobID)]
    HealerPvP_Diabrosis = 1100022,

    [PvP]
    [CustomComboInfo("Melee PvP Role Actions", "", Common.JobID)]
    MeleePvP_RoleActions = 1100030,

    [PvP]
    [ReplaceSkill(AllPvP.Bloodbath)]
    [ParentCombo(MeleePvP_RoleActions)]
    [CustomComboInfo("Bloodbath", "", Common.JobID)]
    MeleePvP_Bloodbath = 1100031,

    [PvP]
    [ReplaceSkill(AllPvP.Swift)]
    [ParentCombo(MeleePvP_RoleActions)]
    [CustomComboInfo("Swift", "", Common.JobID)]
    MeleePvP_Swift = 1100032,

    [PvP]
    [ReplaceSkill(AllPvP.Smite)]
    [ParentCombo(MeleePvP_RoleActions)]
    [CustomComboInfo("Smite", "", Common.JobID)]
    MeleePvP_Smite = 1100033,

    [PvP]
    [CustomComboInfo("Ranged PvP Role Actions", "", Common.JobID)]
    RangedPvP_RoleActions = 1100040,

    [PvP]
    [ReplaceSkill(AllPvP.Dervish)]
    [ParentCombo(RangedPvP_RoleActions)]
    [CustomComboInfo("Dervish", "", Common.JobID)]
    RangedPvP_Dervish = 1100041,

    [PvP]
    [ReplaceSkill(AllPvP.Bravery)]
    [ParentCombo(RangedPvP_RoleActions)]
    [CustomComboInfo("Bravery", "", Common.JobID)]
    RangedPvP_Bravery = 1100042,

    [PvP]
    [ReplaceSkill(AllPvP.EagleEyeShot)]
    [ParentCombo(RangedPvP_RoleActions)]
    [CustomComboInfo("Eagle Eye Shot", "", Common.JobID)]
    RangedPvP_EagleEyeShot = 1100043,

    [PvP]
    [CustomComboInfo("Mage PvP Role Actions", "", Common.JobID)]
    MagePvP_RoleActions = 1100050,

    [PvP]
    [ReplaceSkill(AllPvP.PhantomDart)]
    [ParentCombo(MagePvP_RoleActions)]
    [CustomComboInfo("Phantom Dart", "", Common.JobID)]
    MagePvP_PhantomDart = 1100051,

    [PvP]
    [ReplaceSkill(AllPvP.Rust)]
    [ParentCombo(MagePvP_RoleActions)]
    [CustomComboInfo("Rust", "", Common.JobID)]
